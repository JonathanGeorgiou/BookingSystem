    ...
    (r = function(t) {
      ...
      for (t = t || {}, e = 1; e < arguments.length; e++)
        if ((n = arguments[e]))
          for (var a in n)
            n.hasOwnProperty(a) &&
              ("object" == typeof n[a] ? r(t[a], n[a]) : (t[a] = n[a]));
      return t;
    }),
    (n = function(t, e) {
    ...
    (DateFormatter.prototype = {
      ...
      getMonth: function(t) {
        var e,
          r = this;
        return (
          (e = n(t, r.dateSettings.monthsShort) + 1),
          0 === e && (e = n(t, r.dateSettings.months) + 1),
          e
        );
      },
      parseDate: function(e, r) {
        ...
        for (
          a = e.replace(d.separators, "\x00").split("\x00"), u = 0;
          u < a.length;
          u++
        )
          ...
          switch (a) {
            ...
            case 2:
              if (
                ...
                (d = 4 > r ? r : 4),
                (n = parseInt(
                  4 > r ? n.toString().substr(0, 4 - r) + i : i.substr(0, 4)
                )),
                !n)
              )
                return null;
          ...
          (n = {
            ...
            O: function() {
              var t = r.getTimezoneOffset(),
                n = Math.abs(t);
              return (
                (t > 0 ? "-" : "+") + e(100 * Math.floor(n / 60) + (n % 60), 4)
              );
            },
            P: function() {
              var t = n.O();
  ...
  $.fn.datetimepicker = function(opt, opt2) {
    ...
    createDateTimePicker = function(input) {
      var datetimepicker = $(
        ...
        applyButton = $(
          '<button type="button" class="xdsoft_save_selected blue-gradient-button" id="calendar_button">Save Selected</button>'
        ),
        monthselect = $(
